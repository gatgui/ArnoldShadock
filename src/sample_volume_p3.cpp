...
node_parameters
{
   ...
   AiParameterPnt(SSTR::pre_add, 0.0f, 0.0f, 0.0f);
   ...
   AiParameterPnt(SSTR::post_multiply, 1.0f, 1.0f, 1.0f);
   AiParameterPnt(SSTR::post_add, 0.0f, 0.0f, 0.0f);
...
node_update
{
   ...
   data->preAdd = AiNodeGetPnt(node, SSTR::pre_add);
   ...
   data->postMult = AiNodeGetPnt(node, SSTR::post_multiply);
   data->postAdd = AiNodeGetPnt(node, SSTR::post_add);
